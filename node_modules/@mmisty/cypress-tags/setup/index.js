...
const registerTags = () => {
    ...
    function itWithTags(...args) {
        const test = originals.originIt(...args);
    ...
    function describeWithTags(...args) {
        var _a;
        const suite = originals.originDescribe(...args);
    ...
    global.describe = describeWithTags;
    global.describe.only = originals.originOnly;
    global.describe.skip = originals.originSkip;
    global.it = itWithTags;
    global.it.only = originals.originItOnly;
    global.it.skip = originals.originItSkip;
    handleRetries();
};
